...
export const CANTON_FAIR_PHASE_1_PACKAGE: TourPackage = {
  ...
  destination: 'ក្វាងចូវ + ហ្វូសាន (Guangzhou & Foshan)',
  destinationKm: 'ក្វាងចូវ + ហ្វូសាន (Guangzhou & Foshan)',
  destinationEn: 'Guangzhou & Foshan',
  country: 'China',
  countryKm: 'ប្រទេសចិន',
  countryEn: 'China',
  ...
  optionalPrograms: [
    {
      id: 'opt_canton_b2b_machinery',
      title: 'ជំនួបផ្គូផ្គងពាណិជ្ជកម្ម B2B ជាមួយរោងចក្រគ្រឿងម៉ាស៊ីន និងសម្ភារៈសំណង់ VIP Matchmaking',
      titleKm: 'ជំនួបផ្គូផ្គងពាណិជ្ជកម្ម B2B ជាមួយរោងចក្រគ្រឿងម៉ាស៊ីន និងសម្ភារៈសំណង់ VIP Matchmaking',
      titleEn: 'VIP 1-on-1 Sourcing Matchmaking with Heavy Machinery & Building Materials OEM Suppliers',
      description: 'ការរៀបចំជំនួបទល់មុខជាមួយអ្នកគ្រប់គ្រងរោងចក្រផ្ទាល់ ៣-៥ ក្រុមហ៊ុន អមដោយអ្នកបកប្រែភាសាចិន-ខ្មែរ-អង់គ្លេសឯកទេស',
      descriptionKm: 'ការរៀបចំជំនួបទល់មុខជាមួយអ្នកគ្រប់គ្រងរោងចក្រផ្ទាល់ ៣-៥ ក្រុមហ៊ុន អមដោយអ្នកបកប្រែភាសាចិន-ខ្មែរ-អង់គ្លេសឯកទេស',
      descriptionEn: 'Pre-arranged 1-on-1 executive matchmaking with 3-5 verified tier-1 manufacturers, accompanied by dedicated technical bilingual interpreter.',
      additionalCostUSD: 150,
      durationHours: 3.5,
      recommendedAudience: 'Importers, Contractors & Machinery Buyers',
      recommendedAudienceKm: 'អ្នកនាំចូល វិស្វករម៉ាស៊ីន និងអ្នកម៉ៅការសំណង់',
      recommendedAudienceEn: 'Importers, Contractors & Machinery Buyers',
      highlights: ['Dedicated Chinese-English-Khmer interpreter', 'Direct factory wholesale pricing list', 'Private conference meeting suite'],
      highlightsKm: ['អ្នកបកប្រែផ្ទាល់ភាសាចិន-ខ្មែរ-អង់គ្លេស', 'តារាងតម្លៃបោះដុំពីរោងចក្រផ្ទាល់', 'បន្ទប់ប្រជុំឯកជន VIP'],
      highlightsEn: ['Dedicated Chinese-English-Khmer interpreter', 'Direct factory wholesale pricing list', 'Private conference meeting suite'],
      includesGuide: true,
      includedMeals: ['VIP Executive Banquet'],
      includedMealsKm: ['អាហារពេលល្ងាច VIP'],
      includedMealsEn: ['VIP Executive Banquet'],
      meetingPoint: 'Hotel Executive Conference Lounge (5:30 PM)',
      meetingPointKm: 'បន្ទប់ប្រជុំ VIP ជាន់ទី ៣ សណ្ឋាគារ (ម៉ោង ០៥:៣០ ល្ងាច)',
      meetingPointEn: 'Hotel Executive Conference Lounge (5:30 PM)'
    },
    {
      id: 'opt_pearl_river_vip_cruise',
      title: 'ដំណើរកម្សាន្តនាវាទេសចរណ៍ទន្លេគុជខ្យង Pearl River Night VIP Cruise & Business Networking',
      titleKm: 'ដំណើរកម្សាន្តនាវាទេសចរណ៍ទន្លេគុជខ្យង Pearl River Night VIP Cruise & Business Networking',
      titleEn: 'Pearl River Luxury VIP Night Cruise & Executive Networking Reception',
      description: 'ទស្សនាទេសភាពទីក្រុងក្វាងចូវពេលរាត្រី និងអគារ Canton Tower លើនាវាប្រណិត ជាមួយនឹងស្រាក្រឡុក និងបណ្តាញទំនាក់ទំនងធុរកិច្ច',
      descriptionKm: 'ទស្សនាទេសភាពទីក្រុងក្វាងចូវពេលរាត្រី និងអគារ Canton Tower លើនាវាប្រណិត ជាមួយនឹងស្រាក្រឡុក និងបណ្តាញទំនាក់ទំនងធុរកិច្ច',
      descriptionEn: 'Panoramic illuminated night views of Canton Tower and Pearl River skyline aboard a private VIP yacht with cocktail networking.',
      additionalCostUSD: 65,
      durationHours: 3,
      recommendedAudience: 'All Business Delegates & Spouses',
      recommendedAudienceKm: 'គណៈប្រតិភូធុរកិច្ចទាំងអស់',
      recommendedAudienceEn: 'All Business Delegates & Spouses',
      highlights: ['VIP yacht deck access', 'Canton Tower illuminated panorama', 'Chauffeured return transport'],
      highlightsKm: ['កន្លែងអង្គុយជាន់លើនាវា VIP', 'ទស្សនា Canton Tower បំភ្លឺភ្លើងពណ៌', 'រថយន្ត VIP ជូនដំណើរត្រឡប់មកសណ្ឋាគារ'],
      highlightsEn: ['VIP yacht deck access', 'Canton Tower illuminated panorama', 'Chauffeured return transport'],
      includesGuide: true,
      includedMeals: ['Welcome Drinks & Gourmet Canapés'],
      includedMealsKm: ['ភេសជ្ជៈស្វាគមន៍ & អាហារសម្រន់ប្រណិត'],
      includedMealsEn: ['Welcome Drinks & Gourmet Canapés'],
      meetingPoint: 'Hotel Main Lobby (07:00 PM)',
      meetingPointKm: 'មុខឡប់ប៊ីសណ្ឋាគារ (ម៉ោង ០៧:០០ យប់)',
      meetingPointEn: 'Hotel Main Lobby (07:00 PM)'
    }
  ]
};
...
export const CANTON_FAIR_PHASE_2_PACKAGE: TourPackage = {
  ...
  destination: 'ក្វាងចូវ + ចុងសាន (Guangzhou & Zhongshan)',
  destinationKm: 'ក្វាងចូវ + ចុងសាន (Guangzhou & Zhongshan)',
  destinationEn: 'Guangzhou & Zhongshan',
  country: 'China',
  countryKm: 'ប្រទេសចិន',
  countryEn: 'China',
  category: 'canton_fair',
  ...
  optionalPrograms: [
    {
      id: 'opt_foshan_furniture_shunde',
      title: 'ដំណើរទស្សនកិច្ចផ្សារគ្រឿងសង្ហារឹម និងដេគ័រ Shunde Louvrecity Furniture Hub',
      titleKm: 'ដំណើរទស្សនកិច្ចផ្សារគ្រឿងសង្ហារឹម និងដេគ័រ Shunde Louvrecity Furniture Hub',
      titleEn: 'Foshan Shunde Louvre International Furniture & Luxury Home Decor Sourcing Tour',
      description: 'ដំណើរចុះពិនិត្យផ្សារបោះដុំគ្រឿងសង្ហារឹមធំជាងគេលើពិភពលោក និងជួបម្ចាស់រោងចក្រ OEM ផ្ទាល់',
      descriptionKm: 'ដំណើរចុះពិនិត្យផ្សារបោះដុំគ្រឿងសង្ហារឹមធំជាងគេលើពិភពលោក និងជួបម្ចាស់រោងចក្រ OEM ផ្ទាល់',
      descriptionEn: 'Guided procurement tour of the world largest furniture sourcing mall with direct factory container shipping consultations.',
      additionalCostUSD: 95,
      durationHours: 4.5,
      recommendedAudience: 'Architects, Interior Designers & Furniture Wholesalers',
      recommendedAudienceKm: 'ស្ថាបត្យករ អ្នកដេគ័រ និងអ្នកនាំចូលគ្រឿងសង្ហារឹម',
      recommendedAudienceEn: 'Architects, Interior Designers & Furniture Wholesalers',
      highlights: ['Container consolidation guidance', 'Bilingual sourcing negotiator', 'Direct factory catalogs'],
      highlightsKm: ['ការប្រឹក្សាដឹកជញ្ជូនទូកុងតឺន័រ', 'អ្នកបកប្រែជំនួយការចរចាតម្លៃ', 'កាតាឡុកតម្លៃរោងចក្រ'],
      highlightsEn: ['Container consolidation guidance', 'Bilingual sourcing negotiator', 'Direct factory catalogs'],
      includesGuide: true,
      includedMeals: ['Special Cantonese Seafood Lunch'],
      includedMealsKm: ['អាហារថ្ងៃត្រង់គ្រឿងសមុទ្រក្វាងទុង'],
      includedMealsEn: ['Special Cantonese Seafood Lunch'],
      meetingPoint: 'Hotel Main Driveway (08:30 AM)',
      meetingPointKm: 'មុខសណ្ឋាគារ (ម៉ោង ០៨:៣០ ព្រឹក)',
      meetingPointEn: 'Hotel Main Driveway (08:30 AM)'
    }
  ]
};
...
export const CANTON_FAIR_PHASE_3_PACKAGE: TourPackage = {
  ...
  destination: 'ក្វាងចូវ + សិនជិន (Guangzhou & Shenzhen)',
  ...
  optionalPrograms: [
    {
      id: 'opt_zhongda_textile_sourcing',
      title: 'ដំណើរទស្សនកិច្ចផ្សារក្រណាត់ និងវត្ថុធាតុដើមកាត់ដេរអន្តរជាតិ Zhongda Fabric Market',
      titleKm: 'ដំណើរទស្សនកិច្ចផ្សារក្រណាត់ និងវត្ថុធាតុដើមកាត់ដេរអន្តរជាតិ Zhongda Fabric Market',
      titleEn: 'Zhongda International Garment & Textile Materials Raw Material Procurement Expedition',
      description: 'ការនាំគណៈប្រតិភូចុះជ្រើសរើសប្រភេទសាច់ក្រណាត់ គ្រឿងតុបតែងកាត់ដេរ និងស្បែកជើងពីប្រភពផ្គត់ផ្គង់ដើម',
      descriptionKm: 'ការនាំគណៈប្រតិភូចុះជ្រើសរើសប្រភេទសាច់ក្រណាត់ គ្រឿងតុបតែងកាត់ដេរ និងស្បែកជើងពីប្រភពផ្គត់ផ្គង់ដើម',
      descriptionEn: 'Field procurement walkthrough of Guangzhou massive textile market for direct sampling, swatch book gathering, and bulk logistics setup.',
      additionalCostUSD: 80,
      durationHours: 4,
      recommendedAudience: 'Garment Factory Owners, Fashion Brands & Footwear Retailers',
      recommendedAudienceKm: 'ម្ចាស់រោងចក្រកាត់ដេរ ហាងលក់សម្លៀកបំពាក់ និងស្បែកជើង',
      recommendedAudienceEn: 'Garment Factory Owners, Fashion Brands & Footwear Retailers',
      highlights: ['Fabric swatch book collection', 'Custom dyeing & printing minimums briefing', 'Dedicated logistics coordinator'],
      highlightsKm: ['ការប្រមូលគំរូសាច់ក្រណាត់', 'ការប្រឹក្សាបរិមាណអប្បបរមាក្នុងការកុម្ម៉ង់', 'អ្នកសម្របសម្រួលដឹកជញ្ជូន'],
      highlightsEn: ['Fabric swatch book collection', 'Custom dyeing & printing minimums briefing', 'Dedicated logistics coordinator'],
      includesGuide: true,
      includedMeals: ['Dim Sum High Tea & Refreshments'],
      includedMealsKm: ['តែខ្ពស់ & ឌីមស៊ាំ'],
      includedMealsEn: ['Dim Sum High Tea & Refreshments'],
      meetingPoint: 'Hotel Lobby (01:30 PM)',
      meetingPointKm: 'ឡប់ប៊ីសណ្ឋាគារ (ម៉ោង ០១:៣០ រសៀល)',
      meetingPointEn: 'Hotel Lobby (01:30 PM)'
    }
  ]
};
