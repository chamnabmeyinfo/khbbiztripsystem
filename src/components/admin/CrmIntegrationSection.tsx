  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 border-b border-slate-200 dark:border-slate-800 pb-2">
        ...
        <button
          onClick={() => setAdminActiveTab('audit_log')}
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/40 border border-blue-200 dark:border-blue-800 transition-all cursor-pointer"
        >
