    ...
    <div className="space-y-6">
      ...
      {activeSubTab === 'features' && (
        <div className="space-y-6">
          ...
          {[
            {
              key: 'enableExploreCuratedTours',
              title: '🌐 Explore Curated Tours (Front End Home Page)',
              desc: 'Shows or hides the Explore Curated Tours & Canton Fair catalog section on the public Home Page portal.',
              icon: Globe
            },
            {
              key: 'enableAiCopilot',
            ...
            const isEnabled = (formData as any)[item.key] !== false;
            const Icon = item.icon;
            return (
              <div
                key={item.key}
              ...
              >
                ...
                <label className="relative inline-flex items-center cursor-pointer shrink-0">
                  <input
                    ...
                    checked={isEnabled}
                    onChange={(e) => {
                      handleChange(item.key as any, e.target.checked);
                      handleFeatureToggle(item.key as any, e.target.checked);
                    }}
                    className="sr-only peer"
                  />
