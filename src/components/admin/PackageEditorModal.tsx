  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedPackage: TourPackage = {
      ...
      itinerary: (itinerary || []).map(step => ({
        ...step,
        titleKm: step.title,
        descriptionKm: step.description,
        hotelNameKm: step.hotelName,
        assemblyPointKm: step.assemblyPoint,
        mealsIncludedKm: step.mealsIncluded,
        guideAgenda: (step.guideAgenda || []).map(slot => ({
          ...slot,
          activityKm: slot.activity,
          locationKm: slot.location,
          notesKm: slot.notes
        }))
      })),
      optionalPrograms: (optionalPrograms || []).map(prog => ({
        ...prog,
        titleKm: prog.title,
        descriptionKm: prog.description,
        recommendedAudienceKm: prog.recommendedAudience,
        meetingPointKm: prog.meetingPoint,
        highlightsKm: prog.highlights,
        includedMealsKm: prog.includedMeals
      }))
    };
