...
export const TrendingDeals: React.FC = () => {
  const { packages, setSelectedPackage, setActiveModal, openPackageSalesPage, openPackageEditor, isCorporateEditor, currency, language, t } = useApp();
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-700/80 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        ...
                        <button
                          onClick={() => handleOpenSalesLanding(pkg)}
                          className="hidden sm:flex px-3 py-2 rounded-xl bg-slate-100 hover:bg-indigo-50 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200 text-xs font-bold transition-colors cursor-pointer items-center gap-1"
                        ...
                        <button
                          ...
                          className="px-3.5 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-teal-600 hover:from-indigo-700 hover:to-teal-700 text-white text-xs font-bold shadow-md shadow-indigo-500/20 transition-all cursor-pointer whitespace-nowrap active:scale-95"
                        >
                          {t('bookNow')}
                        </button>
                      </div>
