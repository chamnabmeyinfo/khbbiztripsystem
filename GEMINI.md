...
- **Automatic GitHub Push**: Whenever you finish implementing, updating, or fixing any features in the codebase and verified zero build/compilation/lint errors, you MUST ALWAYS automatically push the latest commits directly to the GitHub repository (`https://github.com/chamnabmeyinfo/khbbiztripsystem.git`) on `origin/main` without waiting for manual user confirmation.
