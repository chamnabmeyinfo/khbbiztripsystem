...
**Components:**
- `HeroSection` — Hero banner with multi-parameter destination/date/traveler search and instant filter
...
5. **Packages (`PackageManagementSection`)**: Tour package catalogue, pricing rules, itinerary editor, and tag management.
